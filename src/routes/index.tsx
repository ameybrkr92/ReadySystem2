...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Ready Systems — Operations Console" },
      { name: "description", content: "Role-based ERP for Ready Systems' wire-harness and switchgear shop. Live floor view for the Director, with Planning, Inventory and Quality working the line." },
      { property: "og:title", content: "Ready Systems — Operations Console" },
      { property: "og:description", content: "One operations console for an MV switchgear contract-assembly shop." },
    ],
  }),
  component: App,
});
...
function App() {
  ...
  if (!session) return (<><Login onLogin={setSession} /><Toaster /></>);
