...
const KEY = "ready-systems-erp-v3";
...
function seed(): State {
  ...
  const orders: Order[] = [
    { id: uid(), woNo: "RS-WO-24-0011", client: "Client A", project: "Project Alpha — MV switchgear Q4", product: "8DJHST", config: "RRL", motorised: false, qty: 4, poDate: days(-20), dueDate: days(15), bomSentDate: days(-18), costingSentDate: days(-16), stage: "Build", bom: seedBom("RRL") },
    ...
    { id: uid(), woNo: "RS-WO-24-0013", client: "Client C", project: "Project Charlie — LOT 3", product: "8DJHST", config: "RRL+ME", motorised: false, qty: 3, poDate: days(-10), dueDate: days(25), bomSentDate: days(-8), stage: "Costing", bom: seedBom("RRL+ME") },
